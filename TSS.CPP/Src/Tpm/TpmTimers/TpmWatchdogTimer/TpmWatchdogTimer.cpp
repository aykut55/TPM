#include "TpmWatchdogTimer.h"

#include <string>       // std::string
#include <iostream>     // std::cout
#include <sstream>      // std::stringstream

CTpmWatchdogTimer::~CTpmWatchdogTimer()
{
    try
    {
...
CTpmWatchdogTimer::CTpmWatchdogTimer(CTpmSharedDevice* sharedDevice)
...
CTpmSharedDevice* CTpmWatchdogTimer::GetTpmSharedDevice(void)
{
    return m_sharedTpmDevice;
}

bool CTpmWatchdogTimer::Release(void)
{
...
bool CTpmWatchdogTimer::Initialize(void)
{
    bool fncReturn = false;
