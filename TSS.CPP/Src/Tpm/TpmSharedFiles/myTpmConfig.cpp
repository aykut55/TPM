...
vector<TPM_ALG_ID> myTpmConfig::ImplementedAlgs;

// Implemented hash algorithms
vector<TPM_ALG_ID> myTpmConfig::HashAlgs;

// All commands implemented by the TPM
vector<TPM_CC> myTpmConfig::ImplementedCommands;


void myTpmConfig::Init(Tpm2& tpm)
{
